# incid-set2.mod LQR2-MN-v-v
# Original AMPL coding by Sven Leyffer, University of Dundee
#
# An MPEC after Outrata, Kocvara & Zowe, Nonsmooth Approach to
...
# be determined.
#
# This problem has a more interesting obstacle than the original
#
...
# ... obstacle 
var xi {i in nodes} = - 0.03 - 0.05 * (x[i]^2 + (y[i]-0.25)^2);
