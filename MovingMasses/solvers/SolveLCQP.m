...
%% Get formulation
LCQP_formulation = ObtainLCQP(problem.casadi_formulation_condensed);
...
solutions.obj = full(problem.casadi_formulation_condensed.Obj(solutions.x));
solutions.compl = full(problem.casadi_formulation_condensed.Phi(solutions.x));
